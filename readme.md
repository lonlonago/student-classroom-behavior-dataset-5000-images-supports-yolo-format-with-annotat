# Student Classroom Behavior Dataset 5000 Images Supports Yolo Format with Annotations in English

# Body

Student Classroom Behavior Dataset, 5000 images, in yolo format, with full annotations, can be directly used for training models

The image content is the behavior of students in a classroom during class, such as raising hands, writing, reading, and other common classroom actions. It is suitable for target detection and behavior analysis related projects. The dataset is an electronic version, which can be downloaded instantly upon capture, saving time and effort.
